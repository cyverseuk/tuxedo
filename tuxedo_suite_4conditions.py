...
import shutil
import glob
parser = argparse.ArgumentParser(description="Process Tophat2 command input")
...
bowtie2build = "/usr/bin/bowtie2-build"
...
# ------------------------------------------ Cufflinks Analysis -------------------------------------------------------
#Binary location
cufflinks = "/root/cufflinks-2.2.1.Linux_x86_64/cufflinks"
...
cuffmerge = "/root/cufflinks-2.2.1.Linux_x86_64/cuffmerge"
...
cuffdiff =  ("/root/cufflinks-2.2.1.Linux_x86_64/cuffdiff")
...
#TODO change path
plot_script = "Rscript /root/cummerbund_plot_scripts.r"
